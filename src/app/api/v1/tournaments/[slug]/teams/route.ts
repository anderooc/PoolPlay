...
import type { TournamentTeamListContract } from "@/lib/api/contracts/tournament";
import { apiHandler } from "@/lib/api/handler";
import { notFound } from "@/lib/api/errors";
import {
  findPostedTournamentId,
  loadPublicTournamentTeams,
...
export const GET = apiHandler(async (_request: Request, context: RouteContext) => {
  ...
  const body: TournamentTeamListContract = {
    teams: await loadPublicTournamentTeams(tournament.id),
  };
