...
import { confirmTournamentHostRegistrations } from "@/lib/api/queries/tournament-host-registrations";
...
export const POST = apiHandler(async (request: Request, context: RouteContext) => {
  ...
  return jsonSuccess(
    await confirmTournamentHostRegistrations(slug, user, body.registrationIds)
  );
});
