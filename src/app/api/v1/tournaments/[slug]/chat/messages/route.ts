...
import { postChatMessageForViewer } from "@/lib/api/queries/tournament-ops-mutations";
...
export const POST = apiHandler(async (request: Request, context: RouteContext) => {
  ...
  if (
    !body ||
    typeof body.channelKind !== "string" ||
    typeof body.body !== "string"
  ) {
    throw badRequest("channelKind and body are required.");
  }
  return jsonSuccess(
    await postChatMessageForViewer(slug, user, {
