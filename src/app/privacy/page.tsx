...
export const metadata = pageMetadata(
  "Privacy",
  "How brackt collects, uses, and retains account and tournament data.",
  { canonical: "/privacy" }
);
        ...
        <article className="container mx-auto max-w-3xl px-4 py-14 sm:py-20">
          <header className="border-b pb-8">
            ...
            <p className="mt-5 max-w-2xl text-pretty leading-relaxed text-foreground/90">
              This notice describes the data brackt currently handles. The
          ...
          <div className="mt-10 space-y-9 text-pretty leading-relaxed text-foreground/90">
            ...
            <section className="space-y-3">
              ...
              <p>
                brackt uses this data to provide accounts, run tournament
            ...
            <section className="space-y-3">
              ...
              <p>
                brackt relies on Supabase for authentication, database,
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                browser storage for preferences such as theme. brackt does not
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                be completed in the app, contact the brackt operator who
